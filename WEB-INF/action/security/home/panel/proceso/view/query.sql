...
and
    r.app_id = p.app_id 
--and
   -- (r.rolename = 'sal_admin' or r.rolename = 'sal_configurador' or r.rolename = 'sal_prestador' or r.rolename = 'sal_ejecutivo' or r.rolename = 'sal_aprobador')
and	
	mi.service_id = s.service_id
and
	mi.menu_id = m.menu_id
and
	(upper(m.title) = upper('Procesos') or upper(m.title) = upper('Registros'))
and
