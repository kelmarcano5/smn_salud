with orden as (
	...
	smn_base.smn_baremos_detalle.bad_precio_moneda_local*smn_base.smn_baremos_detalle.bad_cantidad as monto_local,
	...
	where smn_salud.smn_rel_orden_medica_servicios.smn_ordenes_medicas_id=${fld:orden}
)
