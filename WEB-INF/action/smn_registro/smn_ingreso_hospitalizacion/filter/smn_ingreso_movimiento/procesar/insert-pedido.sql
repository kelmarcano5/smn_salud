...
(
	...
	0,
	(select smn_comercial.smn_cliente.smn_cliente_id from smn_comercial.smn_cliente inner join smn_salud.smn_contratante on smn_salud.smn_contratante.smn_auxiliar_rf = smn_comercial.smn_cliente.smn_auxiliar_rf where smn_salud.smn_contratante.smn_contratante_id=${fld:smn_contratante_id} limit 1),
	...
	(select case when smn_comercial.smn_linea_comercial.smn_tipo_linea_comercial_id is null then 0 else smn_comercial.smn_linea_comercial.smn_tipo_linea_comercial_id end as smn_tipo_linea_comercial_id from smn_comercial.smn_linea_comercial where smn_comercial.smn_linea_comercial.smn_linea_comercial_id=(select case when smn_comercial.smn_rel_centro_fac_linea.smn_linea_comercial_id is null then 0 else smn_comercial.smn_rel_centro_fac_linea.smn_linea_comercial_id end as smn_linea_comercial_id 
		from smn_comercial.smn_centro_facturacion inner join smn_comercial.smn_rel_centro_fac_linea on smn_comercial.smn_rel_centro_fac_linea.smn_centro_facturacion_id = smn_comercial.smn_centro_facturacion.smn_centro_facturacion_id 
		where smn_comercial.smn_centro_facturacion.smn_entidades_rf=${fld:smn_entidad_rf} and smn_comercial.smn_centro_facturacion.smn_sucursales_rf=${fld:smn_sucursal_rf} and smn_comercial.smn_centro_facturacion.smn_areas_servicios_rf=${fld:smn_area_servicio_rf} and smn_comercial.smn_centro_facturacion.smn_unidades_servicios_rf=${fld:smn_unidad_servicio_rf} limit 1)),
	(select case when smn_comercial.smn_rel_centro_fac_linea.smn_linea_comercial_id is null then 0 else smn_comercial.smn_rel_centro_fac_linea.smn_linea_comercial_id end as smn_linea_comercial_id from smn_comercial.smn_centro_facturacion inner join smn_comercial.smn_rel_centro_fac_linea on smn_comercial.smn_rel_centro_fac_linea.smn_centro_facturacion_id = smn_comercial.smn_centro_facturacion.smn_centro_facturacion_id where smn_comercial.smn_centro_facturacion.smn_entidades_rf=${fld:smn_entidad_rf}),
