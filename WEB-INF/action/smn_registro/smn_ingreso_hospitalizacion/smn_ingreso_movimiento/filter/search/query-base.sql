select
	...
	when smn_salud.smn_ingreso_movimiento.inm_estatus ='PR' then 'Procesado'
	end as inm_estatus,
	smn_salud.smn_ingreso_movimiento.smn_ingresos_mov_id as smn_ingreso_movimiento_id,
	smn_salud.smn_presupuesto.smn_presupuesto_id as inm_accion
from 
	...
	LEFT join smn_salud.smn_presupuesto on smn_salud.smn_presupuesto.smn_presupuesto_id = cast(smn_salud.smn_ingreso_movimiento.inm_accion as INTEGER)
where
	smn_salud.smn_ingreso_movimiento.smn_ingresos_mov_id is not null	and smn_salud.smn_ingreso_movimiento.smn_ingreso_id = ${fld:id_ingreso}
 	 	${filter}
order by 
