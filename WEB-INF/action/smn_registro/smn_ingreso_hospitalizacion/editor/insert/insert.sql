...
INSERT INTO smn_salud.smn_ruta_paciente
    ...
    where smn_salud.smn_relacion_unidad_paso.smn_area_servicio_rf=${fld:smn_areas_servicios_rf} and smn_salud.smn_series.sri_codigo='HO' 
    ...
    (select smn_salud.smn_series.smn_series_id from smn_salud.smn_series where smn_salud.smn_series.sri_codigo='HO'),
    (select sri_ultimo_numero from smn_salud.smn_series where sri_codigo = 'HO'),
    '${def:locale}',
    '${def:user}',
    {d '${def:date}'},
    '${def:time}',
