select  smn_base.smn_auxiliar_cond_financiera.smn_auxiliar_cond_financiera_id as id_cond_cont, smn_base.smn_auxiliar_cond_financiera.cfn_codigo|| ' - ' || smn_base.smn_auxiliar_cond_financiera.cfn_descripcion as item 
