with orden as (
	...
	where smn_salud.smn_rel_orden_medica_servicios.smn_ordenes_medicas_id=${fld:orden} and smn_base.smn_baremos_detalle.smn_baremos_id=${fld:baremos} and smn_base.smn_baremos_detalle.bad_estatus='A'
)
