...
inner join smn_salud.smn_presupuesto on smn_salud.smn_presupuesto.smn_auxiliar_rf = smn_base.smn_auxiliar.smn_auxiliar_id
where smn_base.smn_auxiliar.smn_auxiliar_id=${fld:id} and smn_salud.smn_presupuesto.smn_estado_presupuesto_id=4