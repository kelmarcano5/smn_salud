...
where
	smn_salud.smn_presupuesto.smn_presupuesto_id is not null and smn_salud.smn_presupuesto.smn_estado_presupuesto_id in (1,2,4,5) and 
	smn_salud.smn_presupuesto.smn_presupuesto_id=${fld:id_presupuesto}
