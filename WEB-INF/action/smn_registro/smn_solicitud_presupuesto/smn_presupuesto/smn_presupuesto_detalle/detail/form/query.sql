select
	...
	smn_salud.smn_presupuesto_detalle.smn_presupuesto_id as smn_presupuesto_id,
	monalt.mon_nombre ||' Valor de la Tasa=>'|| smn_base.smn_tasas_de_cambio.tca_tasa_cambio as smn_tasa_rf,
