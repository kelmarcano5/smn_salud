...
WHERE
	smn_salud.smn_ingreso_movimiento.smn_ingreso_id = ${fld:id_ingreso} AND smn_base.smn_componentes.cmp_grupo_prestador IS NOT NULL

GROUP BY smn_salud.smn_ingreso_movimiento.smn_ingreso_id, smn_salud.smn_ingreso_movimiento.smn_unidades_servicios_rf, smn_base.smn_componentes.cmp_grupo_prestador, smn_salud.smn_ingreso_movimiento.smn_prestador_servicio_rf
