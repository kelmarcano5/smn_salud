...
WHERE smn_ingresos_id = ${fld:id_ingreso}--and smn_base.smn_tasas_de_cambio.tca_fecha_vigencia=(select smn_salud.smn_ingresos.igs_fecha_ingreso from smn_salud.smn_ingresos where smn_salud.smn_ingresos.smn_ingresos_id = ${fld:id_ingreso}) and  smn_base.smn_tasas_de_cambio.tca_estatus='AC' and smn_base.smn_tasas_de_cambio.tca_tipo_tasa=(select smn_salud.smn_documento.tca_tipo_tasa from smn_salud.smn_documento where smn_salud.smn_documento.smn_documento_id = (select smn_salud.smn_ingresos.smn_documento_id from smn_salud.smn_ingresos where smn_salud.smn_ingresos.smn_ingresos_id = ${fld:id_ingreso}))
