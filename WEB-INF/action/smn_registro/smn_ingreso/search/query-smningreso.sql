...
where 
    smn_salud.smn_ingresos.smn_ingresos_id is not null and smn_salud.smn_ruta_paciente.rta_estatus IN('EA','PE','RV') and 
    ...
    smn_salud.smn_ingresos.smn_unidades_servicios_rf = ${fld:unidad_prestador} and
    smn_salud.smn_ingresos.igs_fecha_registro = current_date
order by 
