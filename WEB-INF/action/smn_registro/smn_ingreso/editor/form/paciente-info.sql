...
inner join smn_salud.smn_ingreso_cola_virtual icv on
		rta.rta_ticket = icv.icv_numero_ticket
...
where 
	...
	rta.rta_ejecutivo_asignado = ${fld:usuario} and rta.rta_fecha_registro = current_date --and rta.rta_ejecutivo_asignado is null and rta.rta_secuencia=1 and rta.rta_fecha_registro = current_date
order by rta.smn_ruta_id DESC
limit 1