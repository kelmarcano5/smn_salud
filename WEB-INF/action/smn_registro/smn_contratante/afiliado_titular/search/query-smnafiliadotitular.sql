select
	...
	smn_salud.smn_documento.smn_documento_id as documento,
		...
		smn_salud.smn_afiliado_titular.afi_auxiliar_rf as afiliado,
...
from
	...
	left outer join smn_salud.smn_documento on smn_salud.smn_documento.smn_documento_id = smn_salud.smn_afiliado_titular.smn_documento_id
