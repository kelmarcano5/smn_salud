select
	...
	ejec_pag.aux_descripcion as coa_ejecutivo_atención_pagador,
...
from
	...
	inner join smn_base.smn_auxiliar ejec_pag on ejec_pag.smn_auxiliar_id = smn_salud.smn_cobertura_admision.coa_ejecutivo_atención_pagador
