document.form1.smn_prestacion_servicio_medico_cabecera_id_name.value='${fld:psc_estatus_pl0@js}';
document.form1.smn_prestacion_servicio_medico_cabecera_id.value='${fld:smn_prestacion_servicio_medico_cabecera_id@#,###,###}';
setComboValue('smn_mov_caja_detalle_id','${fld:smn_mov_caja_detalle_id}','form1');
document.form1.smn_ingresos_mov_id_name.value='${fld:inm_localidad_pl1@js}';
document.form1.smn_ingresos_mov_id.value='${fld:smn_ingresos_mov_id@#,###,###}';
