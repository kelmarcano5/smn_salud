...
(
	...
	${fld:monto_ml},
	${fld:monto_ml},
	(SELECT smn_salud.smn_ingreso_movimiento.smn_moneda_rf FROM smn_salud.smn_ingreso_movimiento where smn_salud.smn_ingreso_movimiento.smn_ingreso_id=${fld:ingresoid} limit 1),
...
) RETURNING smn_pedido_detalle_id, smn_servicios_rf, ${fld:smn_pedido_cabecera_id} as smn_pedido_cabecera_id, ${fld:ingresoid} as ingresoid, ${fld:smn_prestacion_servicio_medico_cabecera_id} as smn_prestacion_servicio_medico_cabecera_id;
