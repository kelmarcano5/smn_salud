...
where
	smn_salud.smn_prestacion_servicio_medico_detalle.psd_tipo_componentes IN ('IT') 
	and smn_salud.smn_prestacion_servicio_medico_cabecera.smn_ingresos_id = ${fld:ingresoid}