SELECT DISTINCT
	smn_salud.smn_ruta_paciente.rta_numero_documento_identidad AS rta_numero_documento_identidad,
	...
	0 AS saldo_ea,
	0 AS frecuencia,
	smn_salud.smn_ruta_paciente.smn_serie_id AS serie eje.aux_descripcion AS rta_ejecutivo_asignado,
