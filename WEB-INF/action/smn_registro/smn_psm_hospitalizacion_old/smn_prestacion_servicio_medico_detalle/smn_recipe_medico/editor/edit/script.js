...
$('#smn_auxiliar_rf').val(auxiliar).change();

var patologia = '${fld:smn_patologia_id}';
$('#smn_patologia_id').val(patologia).change();

var prestador = '${fld:smn_prestador_servicio_rf}';
$('#smn_prestador_servicio_rf').val(prestador).change();

var ordenante = '${fld:rec_ordenante_nombre}';
$('#rec_ordenante_nombre').val(ordenante).change();

var contratante = '${fld:smn_contratante_id}';
$('#smn_contratante_id').val(contratante).change();

var farmaceuta = '${fld:smn_farmaceuta_prestador_servicio_rf}';
$('#smn_farmaceuta_prestador_servicio_rf').val(farmaceuta).change();
...
document.form1.rec_sintoma.value='${fld:rec_sintoma@js}';
