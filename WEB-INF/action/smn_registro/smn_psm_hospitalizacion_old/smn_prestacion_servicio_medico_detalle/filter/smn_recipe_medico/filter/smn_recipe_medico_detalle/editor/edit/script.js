...
$('#smn_principio_activo_rf').val(principio).trigger('change');

var item = '${fld:smn_item_rf}';
$('#smn_item_rf').val(item).trigger('change');

var presentacion = '${fld:smn_presentacion_rf}';
$('#smn_presentacion_rf').val(presentacion).trigger('change');

var unidad = '${fld:smn_unidad_medida_rf}';
$('#smn_unidad_medida_rf').val(unidad).trigger('change');
