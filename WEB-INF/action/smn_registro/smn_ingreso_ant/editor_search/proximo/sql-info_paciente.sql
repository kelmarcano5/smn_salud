...
where 
	rta.rta_estatus = 'EA' and rta.rta_fecha_registro = ${fld:fecha_ingreso} and 
	rta.rta_ticket = ${fld:ticket} and rta.rta_secuencia=1 
order by rta.smn_ruta_id asc limit 1