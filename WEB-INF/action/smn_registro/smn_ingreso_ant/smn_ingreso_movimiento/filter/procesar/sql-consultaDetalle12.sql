...
FROM
    ...
    left join smn_salud.smn_prestacion_servicio_medico_cabecera on smn_salud.smn_prestacion_servicio_medico_cabecera.smn_prestacion_servicio_medico_cabecera_id=${fld:smn_prestacion_servicio_medico_cabecera_id}
    ...
    left join smn_base.smn_grupos_prestadores on smn_base.smn_grupos_prestadores.smn_grupos_prestadores_id =  smn_salud.smn_prestacion_servicio_medico_cabecera.smn_grupo_prestador_rf and  smn_salud.smn_prestacion_servicio_medico_cabecera.smn_grupo_prestador_rf = smn_base.smn_componentes.cmp_grupo_prestador
WHERE
    smn_salud.smn_ingresos.smn_ingresos_id = ${fld:id_ingreso} and smn_base.smn_componentes.cmp_genera_grupo_prestador='SI' and smn_salud.smn_ingreso_movimiento.smn_unidades_servicios_rf=${fld:smn_unidades_servicios_rf} and 
        smn_base.smn_grupo_prestador_servicio_frecuencia.smn_grupos_prestadores_id=${fld:smn_grupo_prestador_rf} and smn_salud.smn_prestacion_servicio_medico_cabecera.smn_prestacion_servicio_medico_cabecera_id=${fld:smn_prestacion_servicio_medico_cabecera_id} 