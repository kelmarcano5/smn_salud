...
FROM
    ...
    left join smn_base.smn_grupos_prestadores on smn_base.smn_grupos_prestadores.smn_grupos_prestadores_id = ${fld:smn_grupo_prestador_rf} and smn_base.smn_componentes.cmp_grupo_prestador=${fld:smn_grupo_prestador_rf}
WHERE
