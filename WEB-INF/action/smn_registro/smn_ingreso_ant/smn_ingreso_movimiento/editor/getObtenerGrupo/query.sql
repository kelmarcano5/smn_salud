...
WHERE
smn_base.smn_grupo_prestador_servicio_frecuencia.smn_servicios_id=${fld:id} AND smn_base.smn_rel_servicio_area_unidad.smn_areas_servicios_rf=${fld:id_area} and smn_base.smn_grupos_prestadores.gpp_is_pull='NO'