...
where smn_base.smn_unidades_servicios.smn_areas_servicios_id=${fld:id} AND smn_base.smn_unidades_servicios.smn_tipo_unidad_administrativa='AD' GROUP BY id order by smn_base.smn_unidades_servicios.uns_codigo desc