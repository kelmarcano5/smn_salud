select	
	...
	(select smn_salud.smn_afiliado_titular.afi_num_control || ' - ' || smn_salud.smn_afiliado_titular.afi_nombres || ' ' || smn_salud.smn_afiliado_titular.afi_apellidos from  smn_salud.smn_afiliado_titular  where smn_salud.smn_afiliado_titular.smn_afiliados_id is not null  and smn_salud.smn_afiliado_titular.smn_afiliados_id=smn_salud.smn_afiliado_titular.smn_afiliados_id  order by 1 ) as smn_afiliados_id_combo,
