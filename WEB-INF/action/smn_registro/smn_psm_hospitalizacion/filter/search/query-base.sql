...
where
		smn_prestacion_servicio_medico_cabecera_id is not null  and smn_base.smn_rel_servicio_area_unidad.smn_unidades_servicios_rf = ${fld:unidad_prestador}
		${filter}
order by
	smn_salud.smn_ingresos.igs_ticket DESC