 SELECT DISTINCT
	...
	case when smn_salud.smn_rel_orden_medica_servicios.smn_prestador_servicio_referido_rf is null then 0 else smn_salud.smn_rel_orden_medica_servicios.smn_prestador_servicio_referido_rf end as smn_prestador_servicio_rf,
