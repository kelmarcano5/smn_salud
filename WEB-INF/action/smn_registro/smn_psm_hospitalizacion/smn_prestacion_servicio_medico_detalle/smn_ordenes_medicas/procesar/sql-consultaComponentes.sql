...
from smn_comercial.smn_pedido_cabecera
	...
	left join smn_base.smn_modulos on smn_base.smn_modulos.smn_modulos_id = 1
	inner join smn_base.smn_servicios_componentes on smn_base.smn_servicios_componentes.smn_servicios_id = smn_comercial.smn_pedido_detalle.smn_servicios_rf
	inner join smn_base.smn_componentes on smn_base.smn_componentes.smn_componentes_id = smn_base.smn_servicios_componentes.smn_componentes_id 
	...
	inner join smn_salud.smn_ordenes_medicas on smn_salud.smn_ordenes_medicas.smn_ingreso_id = ${fld:ingresoid}
	left join smn_salud.smn_rel_orden_medica_servicios on smn_salud.smn_rel_orden_medica_servicios.smn_ordenes_medicas_id = smn_salud.smn_ordenes_medicas.smn_ordenes_medicas_id and  smn_salud.smn_rel_orden_medica_servicios.smn_servicios_rf=${fld:smn_servicios_rf} and smn_base.smn_componentes.cmp_grupo_prestador = smn_salud.smn_rel_orden_medica_servicios.smn_grupo_prestador_rf
where
