...
if (smn_agenda_rf == '' || smn_agenda_rf == 0)  {
	...
	$('#smn_agenda_rf').val(smn_agenda_rf).change();
}
...
var smn_unidad_medida_rf = '${fld:smn_unidad_medida_rf}';
if (smn_unidad_medida_rf == '' || smn_unidad_medida_rf == 0)  {

}else{
	$('#smn_unidad_medida_rf').val(smn_unidad_medida_rf).change();
}


$('#ccq_hora_entrada').val('${fld:ccq_hora_entrada}');
$('#ccq_hora_salida').val('${fld:ccq_hora_salida}');
...
//document.form1.ccq_hora_salida.value='${fld:ccq_hora_salida@js}';
