...
--where
	--smn_salud.smn_control_quirofano.smn_prestacion_servicio_cabecera_id=1

where
	smn_control_quirofano_id is not null and smn_salud.smn_control_quirofano.smn_prestacion_servicio_medico_detalle_id=${fld:id_prestacion_det}
	${filter}
order by
