...
left join smn_inventario.smn_principio_activo on smn_inventario.smn_principio_activo.smn_principio_activo_id = smn_inventario.smn_caracteristica_item.smn_principio_activo_rf
where
smn_inventario.smn_caracteristica_item.smn_principio_activo_rf=${fld:id}