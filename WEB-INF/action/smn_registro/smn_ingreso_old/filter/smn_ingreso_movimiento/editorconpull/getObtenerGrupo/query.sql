...
smn_base.smn_grupos_prestadores.gpp_is_pull as pool
FROM
smn_base.smn_agenda
...
WHERE
smn_base.smn_grupo_prestador_servicio_frecuencia.smn_servicios_id=${fld:id} and smn_base.smn_agenda.age_dia_semana = (select case 
