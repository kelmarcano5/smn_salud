...
from smn_salud.smn_relacion_unidad_paso
   ...
   left join smn_salud.smn_ruta_paciente on smn_salud.smn_ruta_paciente.smn_grupo_prestador_rf = smn_salud.smn_relacion_unidad_paso.smn_grupo_prestador_servicio
   ...
   --inner JOIN smn_base.smn_auxiliar on smn_base.smn_auxiliar.smn_auxiliar_id = smn_salud.smn_ingreso_cola_virtual.smn_auxiliar_rf
where smn_salud.smn_relacion_unidad_paso.smn_area_servicio_rf= ${fld:smn_area_servicio_rf}
  ...
  -- and smn_salud.smn_ingreso_cola_virtual.icv_numero_documento_identidad = ${fld:rta_numero_documento_identidad}