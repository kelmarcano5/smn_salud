...
from 
	...
	inner join smn_salud.smn_ordenes_medicas on smn_salud.smn_ordenes_medicas.smn_ordenes_medicas_id = smn_salud.smn_ingreso_movimiento.inm_num_orden_medica
where
