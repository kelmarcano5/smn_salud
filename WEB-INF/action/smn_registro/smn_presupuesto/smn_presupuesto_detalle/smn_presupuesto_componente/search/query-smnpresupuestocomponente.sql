...
from
	...
	left join smn_base.smn_prestadores_servicios on smn_base.smn_prestadores_servicios.smn_prestadores_servicios_id = smn_salud.smn_presupuesto_componente.smn_prestadores_servicios_rf
	left join smn_base.smn_servicios on smn_base.smn_servicios.smn_servicios_id = smn_salud.smn_presupuesto_componente.smn_servicios_rf

where
	smn_salud.smn_presupuesto_componente.smn_presupuesto_detalle_id = ${fld:id_pre_det} 