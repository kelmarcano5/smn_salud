...
from
	...
	left join smn_base.smn_item on smn_base.smn_item.smn_item_id = smn_salud.smn_presupuesto_impuesto.smn_item_rf
	...
	--inner join smn_base.smn_tasas_de_cambio on smn_base.smn_tasas_de_cambio.smn_tasas_de_cambio_id = smn_salud.smn_presupuesto_impuesto.smn_tasa_rf
	--inner join smn_base.smn_monedas on smn_base.smn_monedas.smn_monedas_id = smn_salud.smn_presupuesto_impuesto.smn_moneda_rf	
where 
	smn_salud.smn_presupuesto_detalle.smn_presupuesto_detalle_id = ${fld:id_pre_det}
order by 
