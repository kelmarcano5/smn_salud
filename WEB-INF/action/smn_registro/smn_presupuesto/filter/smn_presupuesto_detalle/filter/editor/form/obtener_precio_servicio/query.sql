...
where smn_base.smn_baremos_detalle.smn_servicios_rf=${fld:id} and smn_base.smn_baremos_detalle.smn_baremos_id=${fld:smn_baremos_id}
and smn_base.smn_baremos_detalle.bad_tipo_componente='SE' and smn_base.smn_baremos_detalle.bad_estatus='A'