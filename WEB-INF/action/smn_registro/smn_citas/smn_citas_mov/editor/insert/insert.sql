...
(
	...
	(select smn_base.smn_areas_servicios.ase_empresa from smn_base.smn_areas_servicios where smn_base.smn_areas_servicios.smn_areas_servicios_id=(select smn_base.smn_unidades_servicios.smn_areas_servicios_id from smn_base.smn_unidades_servicios where smn_base.smn_unidades_servicios.smn_unidades_servicios_id=${fld:smn_unidades_servicios_rf}) limit 1),
	(select smn_base.smn_areas_servicios.ase_sucursal from smn_base.smn_areas_servicios where smn_base.smn_areas_servicios.smn_areas_servicios_id=(select smn_base.smn_unidades_servicios.smn_areas_servicios_id from smn_base.smn_unidades_servicios where smn_base.smn_unidades_servicios.smn_unidades_servicios_id=${fld:smn_unidades_servicios_rf}) limit 1),
	(select smn_base.smn_unidades_servicios.smn_areas_servicios_id from smn_base.smn_unidades_servicios where smn_base.smn_unidades_servicios.smn_unidades_servicios_id=${fld:smn_unidades_servicios_rf} limit 1),
