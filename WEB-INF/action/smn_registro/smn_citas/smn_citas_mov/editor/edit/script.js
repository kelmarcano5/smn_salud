...
if (smn_unidades_servicios_rf == '' || smn_unidades_servicios_rf == 0)  {

}else{
	$('#smn_unidades_servicios_rf').val(smn_unidades_servicios_rf).change();
}

var smn_tipo_consulta_id = '${fld:smn_tipo_consulta_id}';
if (smn_tipo_consulta_id == '' || smn_tipo_consulta_id == 0)  {

}else{
	$('#smn_tipo_consulta_id').val(smn_tipo_consulta_id).change();
}

var smn_motivos_id = '${fld:smn_motivos_id}';
if (smn_motivos_id == '' || smn_motivos_id == 0)  {

}else{
	$('#smn_motivos_id').val(smn_motivos_id).change();
}
