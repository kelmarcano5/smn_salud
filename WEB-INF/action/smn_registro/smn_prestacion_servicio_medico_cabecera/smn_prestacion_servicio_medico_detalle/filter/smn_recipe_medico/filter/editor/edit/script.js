...
$('#smn_patologia_id').val(patologia).trigger('change');

var prestador = '${fld:smn_prestador_servicio_rf}';
$('#smn_prestador_servicio_rf').val(prestador).trigger('change');

var ordenante = '${fld:rec_ordenante_nombre}';
$('#rec_ordenante_nombre').val(ordenante).trigger('change');

var contratante = '${fld:smn_contratante_id}';
$('#smn_contratante_id').val(contratante).trigger('change');

var farmaceuta = '${fld:smn_farmaceuta_prestador_servicio_rf}';
$('#smn_farmaceuta_prestador_servicio_rf').val(farmaceuta).trigger('change');
