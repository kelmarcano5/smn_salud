SELECT
	...
	smn_base.smn_prestadores_servicios.prs_descripcion AS smn_prestador_servicio_rf_combo,
	smn_base.smn_grupos_prestadores.gpp_descripcion AS smn_grupos_prestadores_id_combo
FROM
