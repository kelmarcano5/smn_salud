...
from
	...
	left join smn_base.smn_auxiliar farmaceuta on farmaceuta.smn_auxiliar_id = smn_salud.smn_recipe_medico.smn_farmaceuta_prestador_servicio_rf
	left join smn_base.smn_auxiliar prestador on prestador.smn_auxiliar_id = smn_base.smn_prestadores_servicios.prs_auxiliar
	left join smn_base.smn_auxiliar on smn_base.smn_auxiliar.smn_auxiliar_id = smn_salud.smn_recipe_medico.smn_auxiliar_rf
	...
	left join smn_salud.smn_prestacion_servicio_medico_cabecera on smn_salud.smn_prestacion_servicio_medico_cabecera.smn_prestacion_servicio_medico_cabecera_id = smn_salud.smn_recipe_medico.smn_prestacion_servicio_medico_id
	left join smn_salud.smn_ingresos on smn_salud.smn_ingresos.smn_ingresos_id = smn_salud.smn_prestacion_servicio_medico_cabecera.smn_ingresos_id
	left join smn_salud.smn_documento on smn_salud.smn_documento.smn_documento_id = smn_salud.smn_ingresos.smn_documento_id
where
