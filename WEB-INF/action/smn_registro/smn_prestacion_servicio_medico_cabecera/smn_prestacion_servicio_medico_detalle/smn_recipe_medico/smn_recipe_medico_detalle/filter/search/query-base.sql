select
	...
	smn_salud.smn_marca_comercial.mac_descripcion as smn_marca_comercial_id,
...
from
	...
	inner join smn_salud.smn_marca_comercial on smn_salud.smn_marca_comercial.smn_marca_comercial_id = smn_salud.smn_recipe_medico_detalle.smn_marca_comercial_id
where
	smn_recipe_medico_detalle_id is not null
	${filter}
order by
