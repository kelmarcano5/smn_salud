select
	...
	case
	when smn_salud.smn_planificacion_de_turno.ptu_estatus=AC then '${lbl:b_active}'
	when smn_salud.smn_planificacion_de_turno.ptu_estatus=IN then '${lbl:b_inactivo}'
	end as ptu_estatus,
