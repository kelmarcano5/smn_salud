...
where smn_base.smn_auxiliar_persona_natural.smn_clase_auxiliar_id = (select smn_base.smn_clase_auxiliar.smn_clase_auxiliar_id from smn_base.smn_clase_auxiliar where smn_base.smn_clase_auxiliar.cla_codigo='PA') 
