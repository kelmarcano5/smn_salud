...
from
	smn_salud.smn_citas
	left join smn_base.smn_auxiliar paciente on paciente.smn_auxiliar_id = smn_salud.smn_citas.cts_auxiliar
	left join smn_base.smn_auxiliar_clase on smn_base.smn_auxiliar_clase.smn_auxiliar_id = smn_salud.smn_citas.cts_auxiliar
	...
	left join smn_base.smn_auxiliar contratante on contratante.smn_auxiliar_id = smn_salud.smn_afiliado_titular.afi_auxiliar_rf
...
where 
	smn_salud.smn_citas.smn_citas_id is not null and smn_salud.smn_citas.cts_usuario='${def:user}'
	${filter}
order by 
	smn_salud.smn_citas.smn_citas_id asc