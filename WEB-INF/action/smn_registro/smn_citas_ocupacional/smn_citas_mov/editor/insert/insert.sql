...
where smn_salud.smn_balance_capacidad_unidad.smn_unidad_servicio_rf=${fld:smn_unidades_servicios_rf}) where smn_salud.smn_capacidades_unidad.smn_unidad_servicio_rf=${fld:smn_unidades_servicios_rf}
