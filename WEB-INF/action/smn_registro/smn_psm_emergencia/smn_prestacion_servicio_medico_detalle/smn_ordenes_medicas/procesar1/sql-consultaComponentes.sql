...
from smn_comercial.smn_pedido_cabecera
	...
	inner join smn_salud.smn_rel_orden_medica_servicios on smn_salud.smn_rel_orden_medica_servicios.smn_ordenes_medicas_id = smn_salud.smn_ordenes_medicas.smn_ordenes_medicas_id and  smn_salud.smn_rel_orden_medica_servicios.smn_servicios_rf=${fld:smn_servicios_rf}
where
