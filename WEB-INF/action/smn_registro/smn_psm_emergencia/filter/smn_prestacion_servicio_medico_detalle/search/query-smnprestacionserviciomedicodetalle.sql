...
where
	smn_salud.smn_prestacion_servicio_medico_detalle.smn_prestacion_servicio_medico_cabecera_id = ${fld:id2} and smn_salud.smn_prestacion_servicio_medico_detalle.psd_tipo_componentes='SE'