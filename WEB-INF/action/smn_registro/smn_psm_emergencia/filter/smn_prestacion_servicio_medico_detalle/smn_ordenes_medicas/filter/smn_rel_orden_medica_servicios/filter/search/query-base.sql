...
from
	...
	inner join smn_base.smn_prestadores_servicios on smn_base.smn_prestadores_servicios.smn_prestadores_servicios_id = smn_salud.smn_rel_orden_medica_servicios.smn_prestador_servicio_referido_rf
where
