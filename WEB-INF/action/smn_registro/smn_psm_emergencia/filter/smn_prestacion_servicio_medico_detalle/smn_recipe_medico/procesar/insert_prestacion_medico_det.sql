...
) RETURNING ${fld:smn_ingreso_id} as smn_ingreso_id, ${fld:smn_documento_id} as smn_documento_id, ${fld:smn_recipe_medico_id} as smn_recipe_medico_id, ${fld:smn_prestador_servicio_rf} as smn_prestador_servicio_rf, ${fld:rmd_dosis_total} as rmd_dosis_total;
