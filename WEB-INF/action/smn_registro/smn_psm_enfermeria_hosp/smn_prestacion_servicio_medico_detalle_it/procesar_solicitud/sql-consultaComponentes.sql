...
WHERE
smn_salud.smn_prestacion_servicio_medico_detalle.smn_ingresos_id = ${fld:ingresoid} 
AND smn_salud.smn_prestacion_servicio_medico_detalle.psd_tipo_componentes = 'IT' 
AND smn_salud.smn_prestacion_servicio_medico_detalle.smn_prestacion_servicio_medico_cabecera_id=${fld:smn_prestacion_servicio_medico_cabecera_id} 
and smn_base.smn_baremos_detalle.bad_estatus = 'A' AND smn_salud.smn_prestacion_servicio_medico_detalle.psd_estatus IN ('RE')