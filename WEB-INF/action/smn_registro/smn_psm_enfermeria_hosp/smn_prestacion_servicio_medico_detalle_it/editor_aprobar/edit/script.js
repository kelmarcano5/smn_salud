setComboValue('smn_descuento_ml_rf','${fld:smn_descuento_ml_rf}','form1');
...
document.form1.psd_cantidad.value='${fld:psd_cantidad@######000}';
document.form1.psd_precio_propuesto_ml.value='${fld:psd_precio_propuesto_ml@######000}';
document.form1.psd_monto_propuesto_ml.value='${fld:psd_monto_propuesto_ml@######000}';
document.form1.smn_descuento_ml_rf.value='${fld:smn_descuento_ml_rf@#######}';
setComboValue('smn_moneda_rf','${fld:smn_moneda_rf}','form1');
document.form1.psd_precio_propuesto_ma.value='${fld:psd_precio_propuesto_ma@######000}';
document.form1.psd_monto_propuesto_ma.value='${fld:psd_monto_propuesto_ma@######000}';
