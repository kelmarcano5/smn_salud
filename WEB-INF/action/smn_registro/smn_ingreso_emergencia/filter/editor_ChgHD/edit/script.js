$('#optionfecha').hide();
$('#igs_fecha_ingreso').prop("disabled",  "true" );
$('#smn_doc_orig').prop("disabled",  "true" );
$('#status_financiero').hide();
$('#monto_alterno').hide();
$('#numauto').hide();
$('#entidad').hide();
$('#sucursal').hide();
...
document.form1.igs_monto_cobertura.value='${fld:igs_monto_cobertura@#,###,###0.00}';
