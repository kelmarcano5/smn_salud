...
FROM
    ...
    inner join smn_base.smn_grupos_prestadores on smn_base.smn_grupos_prestadores.smn_grupos_prestadores_id = ${fld:smn_grupo_prestador_rf} --and  smn_salud.smn_prestacion_servicio_medico_cabecera.smn_grupo_prestador_rf = smn_base.smn_componentes.cmp_grupo_prestador
WHERE
