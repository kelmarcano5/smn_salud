select
	...
	smn_salud.smn_ingresos.igs_monto_cobertura-smn_salud.smn_ingresos.igs_monto_moneda_local as monto_saldo_ml,
	smn_salud.smn_ingresos.igs_monto_cobertura_ma-smn_salud.smn_ingresos.igs_monto_moneda_alterna as monto_saldo_ma,
	...
	smn_base.smn_auxiliar.smn_clase_auxiliar_rf as clase_rf,
...
where 
	...
	smn_salud.smn_ingresos.smn_unidades_servicios_rf = ${fld:unidad_prestador} AND smn_salud.smn_ingresos.igs_estatus_financiero IN('PE')
order by 
