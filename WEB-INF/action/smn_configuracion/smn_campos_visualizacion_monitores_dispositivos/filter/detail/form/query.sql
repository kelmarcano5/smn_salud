select	
	...
	(select smn_salud.smn_dispositivos.dis_codigo || ' - ' || smn_salud.smn_dispositivos.dis_nombre from  smn_salud.smn_dispositivos  where smn_salud.smn_dispositivos.smn_dispositivos_id is not null  and smn_salud.smn_dispositivos.smn_dispositivos_id=smn_salud.smn_campos_visualizacion_monitores_dispositivos.smn_dispositivos_id  order by smn_salud.smn_dispositivos.dis_nombre ) as smn_dispositivos_id_combo,
