...
select
	...
	(select smn_base.smn_usuarios.usr_usuario || ' - ' || smn_base.smn_usuarios.usr_nombres from  smn_base.smn_usuarios  where smn_base.smn_usuarios.smn_usuarios_id is not null  and smn_base.smn_usuarios.smn_usuarios_id=smn_salud.smn_rel_usuarios_entidad.smn_usuario_rf  order by smn_base.smn_usuarios.usr_nombres ) as smn_usuario_rf_combo,
