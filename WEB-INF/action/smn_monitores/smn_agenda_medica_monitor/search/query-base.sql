select
	...
	smn_salud.smn_habitaciones.hab_codigo ||' - '|| smn_salud.smn_habitaciones.hab_descripcion  as consultorio,
...
from
	...
	left join smn_base.smn_grupos_prestadores on smn_base.smn_grupos_prestadores.smn_grupos_prestadores_id = smn_salud.smn_agenda_medica.smn_grupo_prestador_servicio_rf
	left join smn_base.smn_prestadores_servicios on smn_base.smn_prestadores_servicios.smn_prestadores_servicios_id = smn_salud.smn_agenda_medica.smn_prestador_servicio_rf
	left join smn_salud.smn_habitaciones on smn_salud.smn_habitaciones.smn_habitaciones_id = smn_salud.smn_agenda_medica.smn_habitaciones_id
where
	smn_agenda_medica_id is not null
	${filter}
order by
