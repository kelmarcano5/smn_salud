SELECT smn_v_servicio_precio_id AS id_servicio,
	CASE
		WHEN smn_moneda_alterna IS NOT NULL then smn_precio_neto_ma_servicio*(select smn_base.smn_tasas_de_cambio.tca_tasa_cambio from smn_base.smn_tasas_de_cambio where smn_base.smn_tasas_de_cambio.tca_fecha_vigencia=CURRENT_DATE and smn_base.smn_tasas_de_cambio.tca_estatus='AC') ELSE smn_precio_neto_ml_servicio
