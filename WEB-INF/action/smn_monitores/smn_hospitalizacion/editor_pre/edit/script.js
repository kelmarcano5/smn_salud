...
if (smn_entidades_rf == '' || smn_entidades_rf == 0)  {
	...
	$('#smn_entidades_rf').val(smn_entidades_rf).trigger('change');
}
...
if (smn_sucursales_rf == '' || smn_sucursales_rf == 0)  {
	...
	$('#smn_sucursales_rf').val(smn_sucursales_rf).trigger('change');
}
...
if (aux_ord == '' || aux_ord == 0)  {
	...
	$('#smn_auxiliar_ord_rf').val(aux_ord).trigger('change');
}
...
if (ordenes == '' || ordenes == 0)  {
	...
	$('#smn_ordenes_medicas_id').val(ordenes).trigger('change');
}
...
if (smn_patologia_id == '' || smn_patologia_id == 0)  {
	...
	$('#smn_patologia_id').val(smn_patologia_id).trigger('change');
}
