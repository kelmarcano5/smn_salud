...
(
	...
	0,
	(select smn_comercial.smn_cliente.smn_cliente_id from smn_comercial.smn_cliente WHERE smn_comercial.smn_cliente.smn_auxiliar_rf=${fld:smn_auxiliar_pagador_rf}),
	...
	${fld:mcc_fecha_registro},
	${fld:smn_entidad_rf},
	${fld:smn_sucursal_rf},
	${fld:smn_area_servicio_rf},
	${fld:smn_unidad_servicio_rf},
	(select case when smn_comercial.smn_centro_facturacion.smn_centro_costo_rf is null then 0 else smn_comercial.smn_centro_facturacion.smn_centro_costo_rf end as smn_centro_costo_rf from smn_comercial.smn_centro_facturacion where smn_comercial.smn_centro_facturacion.smn_entidades_rf=${fld:smn_entidad_rf}),
	(select smn_comercial.smn_centro_facturacion.smn_centro_facturacion_id from smn_comercial.smn_centro_facturacion where smn_comercial.smn_centro_facturacion.smn_entidades_rf=${fld:smn_entidad_rf}),
