UPDATE smn_salud.smn_coberturas SET
	...
	cob_horario_dias=${fld:cob_horario_dias},
	cob_horario_horas=${fld:cob_horario_horas},
	cob_area_cobertura=${fld:cob_area_cobertura},
	cob_descuento=${fld:cob_descuento},
	cob_tiempo_servicio=${fld:cob_tiempo_servicio},
	smn_tipo_coberturas_id=${fld:smn_tipo_coberturas_id},
