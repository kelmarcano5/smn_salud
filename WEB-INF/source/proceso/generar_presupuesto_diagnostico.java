...
public class generar_presupuesto_diagnostico extends GenericTransaction {
	...
	public int service(Recordset inputParams) throws Throwable{
		...
		try {		
			...
			String sqlCheckImp = getSQL(getResource("sql-consultarDiagnosticoCabecera.sql"), inputParams);
			...
			//File newLogFile = new File("D:/data/Simone/smn_automotriz/log/logGenerarDiagnosticoPresupuesto_"+fechaActual+".txt");
