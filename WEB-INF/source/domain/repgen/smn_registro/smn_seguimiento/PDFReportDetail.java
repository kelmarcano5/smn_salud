package domain.repgen.smn_registro.smn_seguimiento;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("seg_fecha_registro_fin");
			if (d != null)
			{
		...
		d = rs.getString("seg_fecha_registro_ini");
			if (d != null)
			{
			name  = "${lbl:b_store_date}";
			label = "${lbl:b_store_date}";
