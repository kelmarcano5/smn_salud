package domain.repgen.smn_registro.smn_ordenes_medicas;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("omd_fecha_registro_ini");
			if (d != null)
			{
			name  = "b_store_date";
		...
		d = rs.getString("omd_numero_orden");
			if (d != null)
			{
			name  = "b_code";
			label = "${lbl:b_code}";
		...
		d = rs.getString("omd_auxiliar_name");
			if (d != null)
			{
			name  = "b_auxiliary";
			label = "${lbl:b_auxiliary}";
		...
		d = rs.getString("omd_fecha_registro_fin");
			if (d != null)
			{
			name  = "b_store_date";
			label = "${lbl:b_store_date}";
		...
		d = rs.getString("omd_descripcion");
			if (d != null)
			{
			name  = "b_description";
