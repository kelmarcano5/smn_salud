package domain.repgen.smn_configuracion.smn_estatus_citas;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("eci_num_secuencia");
			if (d != null)
			{
			name  = "b_code";
			label = "${lbl:b_code}";
		...
		d = rs.getString("eci_fecha_registro");
			if (d != null)
			{
		...
		d = rs.getString("eci_descripcion");
			if (d != null)
			{
			name  = "b_description";
