package domain.repgen.smn_configuracion.smn_dispositivos;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
			...
			if (d != null)
			{
			name  = "b_area_servicio";
			label = "${lbl:b_area_servicio}";
		...
		d = rs.getString("dis_fecha_registro");
			if (d != null)
			{
			name  = "b_store_date";
