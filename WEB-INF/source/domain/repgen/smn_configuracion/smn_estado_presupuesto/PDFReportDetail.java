package domain.repgen.smn_configuracion.smn_estado_presupuesto;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("epr_fecha_registro");
			if (d != null)
			{
		...
		d = rs.getString("epr_descripcion");
			if (d != null)
			{
			name  = "b_description";
