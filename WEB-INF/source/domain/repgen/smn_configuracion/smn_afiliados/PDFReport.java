package domain.repgen.smn_configuracion.smn_afiliados;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//fila 1 - valor de busqueda
		d = rs.getString("afi_nombre_corto");
		if (d != null)
		{
			name  = "b_name";
			label = "${lbl:b_name}";
		...
		//fila 1 - valor de busqueda
				d = rs.getString("afi_nacionalidad");
				if (d != null)
				{
					name  = "b_citizenship";
					label = "${lbl:b_citizenship}";
				...
				//fila 1 - valor de busqueda
				d = rs.getString("afi_nro_doc_oficial");
				if (d != null)
				{
				...
				//fila 1 - valor de busqueda
				d = rs.getString("afi_telefono_fijo");
				if (d != null)
				{
					name  = "b_fixed_phone";
					label = "${lbl:b_fixed_phone}";
				...
				//fila 1 - valor de busqueda
				d = rs.getString("afi_telefono_movil");
				if (d != null)
				{
					name  = "b_mobile_phone";
					label = "${lbl:b_mobile_phone}";
