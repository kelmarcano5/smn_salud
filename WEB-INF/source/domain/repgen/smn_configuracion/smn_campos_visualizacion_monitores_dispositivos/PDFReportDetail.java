package domain.repgen.smn_configuracion.smn_campos_visualizacion_monitores_dispositivos;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//SIMONE
				d = rs.getString("smn_series_id_name");
			if (d != null)
			{
			name  = "b_serie";
			label = "${lbl:b_serie}";
		...
		d = rs.getString("cvm_fecha_registro");
			if (d != null)
			{
			name  = "b_store_date";
