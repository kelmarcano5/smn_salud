package domain.repgen.smn_configuracion.smn_rel_tipodoc_patologia;
...
public class ExcelReport extends AbstractExcelOutput
{
	...
	public WritableWorkbook createWorkbook(GenericTransaction data, ByteArrayOutputStream buf) throws Throwable
	{
		...
		String nameCustom  = "b_relacion_tipodoc_patologia";
		String labelCustom = "${lbl:b_relacion_tipodoc_patologia}";
