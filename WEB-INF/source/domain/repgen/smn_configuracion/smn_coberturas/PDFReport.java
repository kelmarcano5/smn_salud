package domain.repgen.smn_configuracion.smn_coberturas;
...
public class PDFReport extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		//fila 1 - valor de busqueda
				d = rs.getString("cob_tipo_cobertura");
				if (d != null)
				{
					name  = "b_tipo_cobertura";
					label = "${lbl:b_tipo_cobertura}";
				...
				//fila 1 - valor de busqueda
				d = rs.getString("cob_vigencia_desde");
				if (d != null)
				{
					name  = "b_from_date";
				...
				//fila 1 - valor de busqueda
				d = rs.getString("cob_vigencia_hasta");
				if (d != null)
				{
					name  = "b_to_date";
					label = "${lbl:b_to_date}";
				...
				//fila 1 - valor de busqueda
				d = rs.getString("cob_maximo_cobertura");
				if (d != null)
				{
					name  = "b_max_cobertura";
					label = "${lbl:b_max_cobertura}";
				...
				//fila 1 - valor de busqueda
				d = rs.getString("cob_deducible");
				if (d != null)
				{
					name  = "b_deducible";
					label = "${lbl:b_deducible}";
				...
				//fila 1 - valor de busqueda
				d = rs.getString("cob_porcentaje_deducible");
				if (d != null)
				{
					name  = "b_porcentaje_deducible";
					label = "${lbl:b_porcentaje_deducible}";
