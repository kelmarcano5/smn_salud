package domain.repgen.smn_proceso.smn_rel_control_quirofano_prestador;
...
public class PDFReportDetail extends AbstractPDFOutput
{
	...
	PdfPTable getReportFilter(GenericTransaction data) throws Throwable
	{
		...
		d = rs.getString("smn_grupo_prestador_servicio_rf");
			if (d != null)
			{
		...
		d = rs.getString("smn_prestador_servicio_rf_name");
			if (d != null)
			{
			name  = "b_service_provider";
			label = "${lbl:b_service_provider}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_control_quirofano_id");
			if (d != null)
			{
			name  = "b_control_quirofano";
			label = "${lbl:b_control_quirofano}";
			str_filter = StringUtil.replace(label, label, _labels.getLabel(name, _language));
		...
		d = rs.getString("smn_grupo_prestador_servicio_rf_name");
			if (d != null)
			{
			name  = "b_grupo_prestador_servicio";
			label = "${lbl:b_grupo_prestador_servicio}";
